...
int es_marca_valida(char m[])
{
    ...
    if(strcmp(temp, "NISSAN") == 0) return 1;
...
int es_modelo_valido(char marcaElegida[], char modeloIngresado[])
{
    ...
    if(strcmp(m, "FORD") == 0)
    {
        if(strcmp(mod, "RANGER")==0 || strcmp(mod, "FIESTA")==0 || strcmp(mod, "FOCUS")==0 || strcmp(mod, "KA")==0 || strcmp(mod, "MUSTANG")==0 || strcmp(mod, "ECOSPORT")==0) return 1;
    }
    // 2. CHEVROLET
    else if(strcmp(m, "CHEVROLET") == 0)
    {
        if(strcmp(mod, "CRUZE")==0 || strcmp(mod, "ONIX")==0 || strcmp(mod, "S10")==0 || strcmp(mod, "CAMARO")==0 || strcmp(mod, "TRACKER")==0) return 1;
    }
    // 3. FIAT
    else if(strcmp(m, "FIAT") == 0)
    {
        if(strcmp(mod, "CRONOS")==0 || strcmp(mod, "ARGO")==0 || strcmp(mod, "TORO")==0 || strcmp(mod, "STRADA")==0 || strcmp(mod, "PULSE")==0 || strcmp(mod, "MOBI")==0) return 1;
    }
    // 4. PEUGEOT
    else if(strcmp(m, "PEUGEOT") == 0)
    {
        if(strcmp(mod, "208")==0 || strcmp(mod, "2008")==0 || strcmp(mod, "308")==0 || strcmp(mod, "PARTNER")==0) return 1;
    }
    // 5. VOLKSWAGEN
    else if(strcmp(m, "VOLKSWAGEN") == 0 || strcmp(m, "VW") == 0)
    {
        if(strcmp(mod, "GOL")==0 || strcmp(mod, "GOL TREND")==0 || strcmp(mod, "AMAROK")==0 || strcmp(mod, "POLO")==0 || strcmp(mod, "VENTO")==0 || strcmp(mod, "TAOS")==0) return 1;
    }
    // 6. TOYOTA
    else if(strcmp(m, "TOYOTA") == 0)
    {
        if(strcmp(mod, "HILUX")==0 || strcmp(mod, "COROLLA")==0 || strcmp(mod, "ETIOS")==0 || strcmp(mod, "YARIS")==0 || strcmp(mod, "SW4")==0) return 1;
    }
    // 7. RENAULT
    else if(strcmp(m, "RENAULT") == 0)
    {
        if(strcmp(mod, "SANDERO")==0 || strcmp(mod, "LOGAN")==0 || strcmp(mod, "KANGOO")==0 || strcmp(mod, "DUSTER")==0 || strcmp(mod, "KWID")==0 || strcmp(mod, "ALASKAN")==0) return 1;
    }
    // --- LAS QUE FALTABAN ---
    else if(strcmp(m, "NISSAN") == 0)
    {
        if(strcmp(mod, "VERSA")==0 || strcmp(mod, "SENTRA")==0 || strcmp(mod, "KICKS")==0 || strcmp(mod, "FRONTIER")==0) return 1;
    }
    else if(strcmp(m, "HONDA") == 0)
    {
        if(strcmp(mod, "CIVIC")==0 || strcmp(mod, "FIT")==0 || strcmp(mod, "HR-V")==0 || strcmp(mod, "CR-V")==0) return 1;
    }
    else if(strcmp(m, "CITROEN") == 0)
    {
        if(strcmp(mod, "C3")==0 || strcmp(mod, "C4")==0 || strcmp(mod, "BERLINGO")==0 || strcmp(mod, "C4 CACTUS")==0) return 1;
    }
    else if(strcmp(m, "JEEP") == 0)
    {
        if(strcmp(mod, "RENEGADE")==0 || strcmp(mod, "COMPASS")==0 || strcmp(mod, "WRANGLER")==0) return 1;
    }
    // DEPORTIVOS / LUJO
    else if(strcmp(m, "FERRARI") == 0)
    {
        if(strcmp(mod, "488")==0 || strcmp(mod, "F8")==0 || strcmp(mod, "PORTOFINO")==0) return 1;
    }
    else if(strcmp(m, "BMW") == 0)
    {
        if(strcmp(mod, "X5")==0 || strcmp(mod, "SERIE 3")==0 || strcmp(mod, "320")==0 || strcmp(mod, "118")==0) return 1;
    }
    else if(strcmp(m, "MERCEDES BENZ") == 0 || strcmp(m, "MERCEDES") == 0)
    {
        if(strcmp(mod, "CLASE A")==0 || strcmp(mod, "CLASE C")==0 || strcmp(mod, "GLA")==0 || strcmp(mod, "SPRINTER")==0) return 1;
    }
    else if(strcmp(m, "AUDI") == 0)
    {
        if(strcmp(mod, "A1")==0 || strcmp(mod, "A3")==0 || strcmp(mod, "A4")==0 || strcmp(mod, "Q3")==0 || strcmp(mod, "Q5")==0) return 1;
    }
    else if(strcmp(m, "PORSCHE") == 0)
    {
        if(strcmp(mod, "911")==0 || strcmp(mod, "CAYENNE")==0 || strcmp(mod, "MACAN")==0 || strcmp(mod, "PANAMERA")==0) return 1;
    }
    else if(strcmp(m, "LAMBORGHINI") == 0)
    {
        if(strcmp(mod, "AVENTADOR")==0 || strcmp(mod, "HURACAN")==0 || strcmp(mod, "URUS")==0) return 1;
    }
    else if(strcmp(m, "MCLAREN") == 0)
    {
        if(strcmp(mod, "720S")==0 || strcmp(mod, "GT")==0 || strcmp(mod, "ARTURA")==0) return 1;
    }
